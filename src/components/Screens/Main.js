        ...
        return (
            <div className="wrapper">
                <Container style={{ padding: 0, width: '30%', height: '80vh', backgroundColor: '#011627'}}>
                    ...
                    <Row onClick={ () => this.handleDigit('0') } style={{ margin: 0, padding: 0 }}>
                        <Col md="6" style={{ margin: 0, padding: 5, paddingRight: 0, paddingBottom: 0 }}>
                            <div className="button"> 0 </div>
                        </Col>
                        <Button value='.'/>
                        <ButtonSpecial onClick={ () => this.setState({ currentOperation: '=' }) } value='='/>                         
                    </Row>
                </Container>
             </div>
        );
